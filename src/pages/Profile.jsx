        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 dark:text-gray-200 rounded-lg shadow p-6">
            ...
            <div className="text-center">
              ...
              <div className="mt-6 space-y-3 text-gray-700 dark:text-gray-300 text-sm">
          ...
          <div className="lg:col-span-2 bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 w-full p-2 border rounded bg-white dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600"
                  />
                  {errors.name && (
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="md:col-span-2">
                    <label className="block text-sm font-medium text-gray-800 dark:text-gray-200">Street</label>
                    <input
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-800 dark:text-gray-200">City</label>
                    <input
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-800 dark:text-gray-200">State</label>
                    <input
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-800 dark:text-gray-200">ZIP Code</label>
                    <input
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-800 dark:text-gray-200">Country</label>
                    <input
              ...
              {user.role === "logistics" && (
                <div>
                  <label className="block text-sm font-medium text-gray-800 dark:text-gray-200">Organization</label>
                  <input
